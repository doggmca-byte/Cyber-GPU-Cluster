 ...
 *
 * З переходом на Pro крон /api/cron/deposits ходить кожні 5 хвилин, тож цей
 * скан більше не рятує від майже добового очікування — він лишається заради
 * того, щоб переказ зараховувався за секунди після того, як людина відкрила
 * застосунок, а не за хвилини.
 *
