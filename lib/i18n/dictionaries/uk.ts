...
const uk: TranslationDictionary = {
  ...
  notifications: {
    productionPaused: () =>
      "Сховище ферми переповнене! Зайдіть у Cyber GPU Cluster, щоб зібрати $HASH та продовжити майнінг.",
    ...
    dailyBonusReady: `🎁 Щоденний бонус готовий.\n\nЗабрати — один дотик, а серія продовжує рости.`,
    tasksWaiting: (count: number, reward: string) =>
      `✅ У тебе ${count} невиконаних завдань — разом до ${reward} TON.\n\nБільшість забирає менше хвилини.`,
  ...
  market: {
    ...
    notEnough: (amount: string) => `Не вистачає ${amount} TON`,
    reviveOnFarm: "Оживи на Фермі, щоб знову купувати",
    promo: {
      banner: (percent) => `-${percent}% на обрані риги`,
      anniversaryBanner: (percent) => `🎉 1 Місяць Cyber GPU Cluster! Знижка ${percent}% на все обладнання`,
      endsIn: (days, time) => `До кінця акції: ${days} дн. ${time}`,
    },
    cycles: {
