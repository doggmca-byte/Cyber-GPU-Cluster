...
const uk: TranslationDictionary = {
  ...
  wallet: {
    ...
    deposit: {
      ...
      resumeTitle: "Знайдено незавершений депозит",
      resumeBody: "Можливо, ти вже надсилав цю транзакцію. Перевір її, перш ніж надсилати TON знову — повтор відправить нову, окрему оплату.",
      resumeCheckButton: "Перевірити зараз",
      resumeChecking: "Перевіряємо...",
      resumeDismissButton: "Скасувати",
    },
    withdraw: {
      title: "Вивести TON",
