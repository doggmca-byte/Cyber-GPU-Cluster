...
const en = {
  ...
  wallet: {
    ...
    deposit: {
      ...
      resumeTitle: "Unconfirmed deposit found",
      resumeBody: "You may have already sent this transaction. Check it before sending TON again — retrying will send a new, separate payment.",
      resumeCheckButton: "Check now",
      resumeChecking: "Checking...",
      resumeDismissButton: "Discard",
    },
    withdraw: {
      title: "Withdraw TON",
