...
const es: TranslationDictionary = {
  ...
  wallet: {
    ...
    deposit: {
      ...
      resumeTitle: "Se encontró un depósito sin confirmar",
      resumeBody: "Puede que ya hayas enviado esta transacción. Revísala antes de enviar TON de nuevo — reintentar enviará un pago nuevo y separado.",
      resumeCheckButton: "Revisar ahora",
      resumeChecking: "Revisando...",
      resumeDismissButton: "Descartar",
    },
    withdraw: {
      title: "Retirar TON",
