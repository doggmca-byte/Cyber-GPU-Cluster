...
const es: TranslationDictionary = {
  ...
  notifications: {
    ...
    welcomeLaunchButton: "🚀 Iniciar el juego",
    welcomeCommunityButton: "📢 Unirse a la comunidad",
    welcomeChatButton: "💬 Unirse al chat",
  },
  intro: {
  ...
  exchange: {
    hashToTon: {
      ...
      minAmountError: (min) => `El importe mínimo es ${min} HASH`,
    ...
    convertBack: {
      ...
      gameLabel: "Game",
      amountPlaceholder: (min) => `Mínimo ${min}`,
      minAmountError: (min) => `El importe mínimo es ${min} TON`,
      submit: "Transferir",
  ...
  tasks: {
    ...
    items: {
      ...
      memefarm_open: {
        title: "MEME FARM",
        description: "Abre MEME FARM y crea tu perfil.",
      },
      first_deposit: {
  ...
  retentionTasks: {
    sectionTitle: "Tareas especiales",
    sectionSubtitle: "Mantén la condición activa durante las 6 etapas — la recompensa crece en cada etapa.",
    nameTagTitle: "Añade nuestra etiqueta a tu nombre",
    nameTagDescription: "Añade el texto de abajo a tu nombre o apellido de Telegram.",
    bioLinkTitle: "Añade tu enlace de referido a la Bio",
    bioLinkDescription: "Añade tu enlace de referido personal de abajo a tu Bio de Telegram.",
    copyLabel: "Texto requerido",
    copyButton: "Copiar",
    copied: "¡Copiado!",
    rewardProgress: (current, total, unit) => `${current} / ${total} ${unit}`,
    stageLabel: (n) => `Etapa ${n}`,
    unitMinutes: (n) => `${n} min`,
    unitHours: (n) => `${n} h`,
    unitDays: (n) => `${n} d`,
    startButton: "Empezar",
    ...
    verifying: "Verificando...",
    readyToVerify: "¡Listo — toca Verificar!",
    countdownLabel: (time) => `Próxima verificación en ${time}`,
    notStartedHint: "Añádelo arriba y luego toca Empezar.",
    fullyCompletedTitle: "¡Completado del todo!",
    fullyCompletedHint: "Reclamaste la recompensa completa de esta tarea.",
    bioPrivacyWarning: "Para verificar, la privacidad de tu Bio en Telegram debe estar en «Todos».",
    errorTagMissing: "No se encontró la etiqueta en tu nombre. Añádela e inténtalo de nuevo.",
    errorBioHidden:
      "No se encontró tu enlace de referido en la Bio — asegúrate de que la privacidad de la Bio esté en «Todos» y que el enlace esté ahí.",
    errorCheckFailed: "No se pudo verificar ahora mismo — inténtalo en un momento.",
    errorGenericStart: "No se pudo iniciar la etapa. Inténtalo de nuevo.",
    errorGenericVerify: "No se pudo verificar la etapa. Inténtalo de nuevo.",
    errorTimerReset:
      "La condición ya no se cumple — el temporizador de la etapa se reinició. Vuelve a añadirla y toca Empezar de nuevo.",
    rewardToast: (amount) => `+${amount} TON — ¡etapa completada!`,
    loadError: "No se pudieron cargar las tareas especiales.",
  },
};
