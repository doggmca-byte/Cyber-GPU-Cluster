...
const kk: TranslationDictionary = {
  ...
  wallet: {
    ...
    deposit: {
      ...
      resumeTitle: "Аяқталмаған депозит табылды",
      resumeBody: "Мүмкін, бұл транзакцияны бұрын жіберген боларсың. TON-ды қайта жібермес бұрын тексер — қайталау жаңа, бөлек төлем жібереді.",
      resumeCheckButton: "Қазір тексеру",
      resumeChecking: "Тексерілуде...",
      resumeDismissButton: "Бас тарту",
    },
    withdraw: {
      title: "TON шығару",
