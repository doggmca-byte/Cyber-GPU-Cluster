...
const id: TranslationDictionary = {
  ...
  wallet: {
    ...
    deposit: {
      ...
      resumeTitle: "Ditemukan setoran yang belum selesai",
      resumeBody: "Mungkin kamu sudah mengirim transaksi ini. Periksa dulu sebelum mengirim TON lagi — mencoba lagi akan mengirim pembayaran baru yang terpisah.",
      resumeCheckButton: "Periksa sekarang",
      resumeChecking: "Memeriksa...",
      resumeDismissButton: "Abaikan",
    },
    withdraw: {
      title: "Tarik TON",
