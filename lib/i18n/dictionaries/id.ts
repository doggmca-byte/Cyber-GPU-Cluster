...
const id: TranslationDictionary = {
  ...
  notifications: {
    productionPaused: () =>
      "Penyimpanan farm sudah penuh! Buka Cyber GPU Cluster untuk mengumpulkan $HASH dan melanjutkan penambangan.",
    ...
    dailyBonusReady: `🎁 Bonus harianmu sudah siap.\n\nCukup satu ketukan, dan rentetanmu terus bertambah.`,
    tasksWaiting: (count: number, reward: string) =>
      `✅ Ada ${count} tugas yang belum selesai — total hingga ${reward} TON.\n\nKebanyakan selesai dalam waktu kurang dari semenit.`,
  ...
  exchange: {
    hashToTon: {
      ...
      minAmountError: (min) => `Jumlah minimum adalah ${min} HASH`,
    ...
    convertBack: {
      ...
      gameLabel: "Game",
      amountPlaceholder: (min) => `Minimum ${min}`,
      minAmountError: (min) => `Jumlah minimum adalah ${min} TON`,
      submit: "Pindahkan",
  ...
  wallet: {
    ...
    deposit: {
      ...
      minDepositNote: (min) => `Setoran minimum yang disarankan: ${min} TON.`,
  ...
  retentionTasks: {
    sectionTitle: "Tugas Spesial",
    sectionSubtitle: "Pertahankan kondisi selama 6 tahap — hadiah bertambah setiap tahap.",
    nameTagTitle: "Tambahkan Tag Kami ke Namamu",
    nameTagDescription: "Tambahkan teks di bawah ini ke nama depan atau belakang Telegram-mu.",
    bioLinkTitle: "Tambahkan Tautan Referalmu ke Bio",
    bioLinkDescription: "Tambahkan tautan referal pribadimu di bawah ini ke Bio Telegram.",
    copyLabel: "Teks yang dibutuhkan",
    copyButton: "Salin",
    copied: "Tersalin!",
    ...
    verifying: "Memverifikasi...",
    readyToVerify: "Siap — ketuk Verifikasi!",
    countdownLabel: (time) => `Pemeriksaan berikutnya dalam ${time}`,
    notStartedHint: "Tambahkan di atas, lalu ketuk Mulai.",
    fullyCompletedTitle: "Selesai sepenuhnya!",
    fullyCompletedHint: "Kamu telah mengklaim hadiah penuh untuk tugas ini.",
    bioPrivacyWarning: 'Untuk verifikasi, privasi Bio Telegram-mu harus diatur ke "Semua Orang".',
    errorTagMissing: "Tag tidak ditemukan di namamu. Tambahkan lalu coba lagi.",
    errorBioHidden:
      'Tautan referalmu tidak ditemukan di Bio — pastikan privasi Bio diatur ke "Semua Orang" dan tautannya ada di sana.',
    errorCheckFailed: "Tidak dapat memverifikasi saat ini — coba lagi sebentar.",
    errorGenericStart: "Tidak dapat memulai tahap. Coba lagi.",
    errorGenericVerify: "Tidak dapat memverifikasi tahap. Coba lagi.",
    errorTimerReset: "Kondisi tidak lagi terpenuhi — timer tahap direset. Tambahkan lagi dan ketuk Mulai lagi.",
    rewardToast: (amount) => `+${amount} TON — tahap selesai!`,
    loadError: "Tidak dapat memuat tugas spesial.",
  },
};
