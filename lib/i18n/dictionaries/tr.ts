...
const tr: TranslationDictionary = {
  ...
  wallet: {
    ...
    deposit: {
      ...
      resumeTitle: "Tamamlanmamış bir yatırım bulundu",
      resumeBody: "Bu işlemi daha önce göndermiş olabilirsin. Tekrar TON göndermeden önce kontrol et — yeniden denemek ayrı, yeni bir ödeme gönderir.",
      resumeCheckButton: "Şimdi kontrol et",
      resumeChecking: "Kontrol ediliyor...",
      resumeDismissButton: "Vazgeç",
    },
    withdraw: {
      title: "TON Çek",
