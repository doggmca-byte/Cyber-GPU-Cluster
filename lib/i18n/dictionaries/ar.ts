...
const ar: TranslationDictionary = {
  ...
  wallet: {
    ...
    deposit: {
      ...
      resumeTitle: "تم العثور على إيداع غير مكتمل",
      resumeBody: "ربما تكون قد أرسلت هذه المعاملة بالفعل. تحقق منها قبل إرسال TON مرة أخرى — إعادة المحاولة سترسل دفعة جديدة منفصلة.",
      resumeCheckButton: "تحقق الآن",
      resumeChecking: "جارٍ التحقق...",
      resumeDismissButton: "تجاهل",
    },
    withdraw: {
      title: "سحب TON",
