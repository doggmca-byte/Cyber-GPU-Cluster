...
const ar: TranslationDictionary = {
  ...
  notifications: {
    ...
    dailyBonusReady: `🎁 مكافأتك اليومية جاهزة.\n\nنقرة واحدة تكفي، وسلسلتك تستمر في النمو.`,
    tasksWaiting: (count: number, reward: string) =>
      `✅ لديك ${count} مهام غير مكتملة — حتى ${reward} TON إجمالاً.\n\nمعظمها يستغرق أقل من دقيقة.`,
  ...
  tasks: {
    ...
    items: {
      ...
      subscribe_payouts_channel: {
        title: "اشترك في قناة المدفوعات",
        description: "انضم إلى القناة التي تُنشر فيها جميع المدفوعات.",
      },
      visit_website: {
      ...
      dogs_house_miner_start: {
        ...
        description: "شغّل البوت وابدأ بتعدين GRAM.",
      },
      mrg_miner_start: {
        title: "MRG Miner",
