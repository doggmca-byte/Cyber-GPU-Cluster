...
//
// Мусить бути ДОВШИМ за весь бюджет повторів у UserDataProvider.sync
// (3 спроби по 8с + паузи 0.3с і 0.9с = 25.2с). Інакше він забирав би
// перемогу в останньої спроби: гравець бачив би "Проблема зі з'єднанням"
// у ту саму мить, коли sync уже майже дотягнувся до успішної відповіді.
const FAILSAFE_TIMEOUT_MS = 27000;
